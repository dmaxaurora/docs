...
description: "API key authentication for the Cadence Partner API"
---
...
API keys are created in the **Cadence admin UI**:
...
- Keys are SHA-256 hashed before storage — Cadence never stores your plaintext key
