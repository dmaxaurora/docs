...
curl -X POST -H "X-Partner-API-Key: pk_live_YOUR_KEY_HERE" \
  "https://partner-api-6z2czs6nwa-ue.a.run.app/api/v2/partner/residuals/reports/2026/1/merchants/export"
```
...
curl -H "X-Partner-API-Key: pk_live_YOUR_KEY_HERE" \
  "https://partner-api-6z2czs6nwa-ue.a.run.app/api/v2/partner/residuals/exports/{export_id}/download"
