---
title: "Introduction"
description: "Access merchant data, pricing, residuals, and AI insights through the Cadence Partner API"
---

# Cadence Partner API

The Cadence Partner API gives ISO partners programmatic access to their merchant portfolio — including merchant details, transaction data, pricing breakdowns, residual reports, and AI-powered insights.
...
```
https://partner-api-6z2czs6nwa-ue.a.run.app/api/v2/partner
```
