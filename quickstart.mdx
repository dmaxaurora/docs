...
const response = await fetch(
  "https://modulate.aurorapayments.net/api/v2/partner/merchants?page=1&page_size=5",
  { headers: { "X-Partner-API-Key": "pk_live_YOUR_KEY_HERE" } }
);
...
req, _ := http.NewRequest("GET",
    "https://modulate.aurorapayments.net/api/v2/partner/merchants?page=1&page_size=5", nil)
